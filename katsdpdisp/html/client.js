...
function setsignals(){
    ...
    }else if (signaltext=='timeseries' || signaltext.slice(0,8)=='spectrum' || signaltext.slice(0,9)=='waterfall' || signaltext.slice(0,11)=='periodogram' || signaltext.slice(0,3)=='lag' || signaltext.slice(0,8)=='bandpass' || signaltext.slice(0,4)=='gain' || signaltext.slice(0,6)=='gainmx' || signaltext.slice(0,5)=='delay')
    {
